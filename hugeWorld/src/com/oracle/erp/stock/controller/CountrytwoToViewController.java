...
/**
 * Servlet implementation class Country2ToViewController
 */
@WebServlet("/user/countrytwotoview.do")
public class CountrytwoToViewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CountrytwoToViewController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			RequestDispatcher rd=request.getRequestDispatcher("country2.jsp");

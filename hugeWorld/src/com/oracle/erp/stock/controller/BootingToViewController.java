...
/**
 * Servlet implementation class BootingToViewController
 */
@WebServlet("/user/bootingtoview.do")
public class BootingToViewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BootingToViewController() {
        super();

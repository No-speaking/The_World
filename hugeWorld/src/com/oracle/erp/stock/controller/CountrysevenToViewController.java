...
/**
 * Servlet implementation class Country7ToViewController
 */
@WebServlet("/user/countryseventoview.do")
public class CountrysevenToViewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CountrysevenToViewController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			RequestDispatcher rd=request.getRequestDispatcher("country7.jsp");

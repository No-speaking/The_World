...
/**
 * Servlet implementation class CountryfortenToViewController
 */
@WebServlet("/user/countryfortentoview.do")
public class CountryfortenToViewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CountryfortenToViewController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			RequestDispatcher rd=request.getRequestDispatcher("country14.jsp");

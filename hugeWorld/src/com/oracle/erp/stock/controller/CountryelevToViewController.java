...
/**
 * Servlet implementation class CountryelevToViewController
 */
@WebServlet("/user/countryelevtoview.do")
public class CountryelevToViewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CountryelevToViewController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			RequestDispatcher rd=request.getRequestDispatcher("country11.jsp");

...
/**
 * Servlet implementation class CountryToViewController
 */
@WebServlet("/user/countrytoview.do")
public class CountryToViewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CountryToViewController() {
        super();

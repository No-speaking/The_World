...
/**
 * Servlet implementation class NameToViewController
 */
@WebServlet("/user/toviewname.do")
public class IndexToViewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IndexToViewController() {
        super();

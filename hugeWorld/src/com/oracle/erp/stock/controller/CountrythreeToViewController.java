...
/**
 * Servlet implementation class Country3ToViewController
 */
@WebServlet("/user/countrythreetoview.do")
public class CountrythreeToViewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CountrythreeToViewController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			RequestDispatcher rd=request.getRequestDispatcher("country3.jsp");

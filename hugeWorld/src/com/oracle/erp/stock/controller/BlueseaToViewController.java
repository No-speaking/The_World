...
/**
 * Servlet implementation class BlueseaToViewController
 */
@WebServlet("/user/blueseatoview.do")
public class BlueseaToViewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BlueseaToViewController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			RequestDispatcher rd=request.getRequestDispatcher("blueSea.jsp");

...
/**
 * Servlet implementation class ContactToViewController
 */
@WebServlet("/user/contacttoview.do")
public class ContactToViewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ContactToViewController() {
        super();

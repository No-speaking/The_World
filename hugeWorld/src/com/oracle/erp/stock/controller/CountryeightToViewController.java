...
/**
 * Servlet implementation class Country8ToViewController
 */
@WebServlet("/user/countryeighttoview.do")
public class CountryeightToViewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CountryeightToViewController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			RequestDispatcher rd=request.getRequestDispatcher("country8.jsp");
